      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          events.forEach(function (item, key) {
            ...
            containerCalendar.setAttribute('id', "calendar-".concat(key));
            containerCol.appendChild(containerCalendar);
            container.appendChild(containerCol);
            console.log(item);
            var calendar = new FullCalendar.Calendar(document.getElementById("calendar-".concat(key)), {
